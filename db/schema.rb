...
ActiveRecord::Schema.define(version: 20161010214742) do
  ...
  add_index "card_users", ["card_id", "user_id"], name: "index_card_users_on_card_id_and_user_id", unique: true, using: :btree
